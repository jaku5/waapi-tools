...
namespace PropertyContainerAuditor.UI.Tests
{
    public class MainViewModelTests
    {
        private readonly Mock<IPropertyContainerAuditorService> _sanitizerServiceMock;
        ...
        {
            _sanitizerServiceMock = new Mock<IPropertyContainerAuditorService>();
        ...
        public void WindowTitle_WhenWwise2025_UsesPropertyContainerNomenclature()
        {
            ...
            // Assert
            Assert.StartsWith("Property Container Auditor", _viewModel.WindowTitle);
        }
