...
namespace JPAudio.WaapiTools.Tool.PropertyContainerAuditor.Core.Tests
{
  public class PropertyContainerAuditorServiceTests
  {
    private Mock<IJsonClient>? _clientMock;
    private Mock<ILogger<PropertyContainerAuditorService>>? _loggerMock;
    private PropertyContainerAuditorService? _service;

    private void SetupTest()
    {
      _clientMock = new Mock<IJsonClient>();
      _loggerMock = new Mock<ILogger<PropertyContainerAuditorService>>();
      _service = new PropertyContainerAuditorService(_clientMock.Object, _loggerMock.Object);
    }
