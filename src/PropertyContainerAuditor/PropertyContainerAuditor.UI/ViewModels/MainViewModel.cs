...
using PropertyContainerAuditor.UI.Services;
...
namespace PropertyContainerAuditor.UI.ViewModels
{
    public class MainViewModel : INotifyPropertyChanged
    {
        private readonly IPropertyContainerAuditorService _service;
        ...
        public MainViewModel(IPropertyContainerAuditorService service, ILogger<MainViewModel> logger, IMessenger messenger, IDialogService dialogService, IDispatcherService dispatcherService)
        {
            IsNotConnected = true;
