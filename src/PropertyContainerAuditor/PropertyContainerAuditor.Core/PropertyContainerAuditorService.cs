...
namespace JPAudio.WaapiTools.Tool.PropertyContainerAuditor.Core
{
    public class PropertyContainerAuditorService : IPropertyContainerAuditorService
    {
        private readonly IJsonClient _client;
        private readonly ILogger<PropertyContainerAuditorService> _logger;
        ...
        public PropertyContainerAuditorService(IJsonClient client, ILogger<PropertyContainerAuditorService> logger)
        {
            _client = client;
